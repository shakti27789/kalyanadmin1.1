...
<script id="subadminHandler" type="text/x-handlebars-template">
                           ...
                           {{#if_eq id ${user.id}}} 
							...
							{{else}}
							 <td><span class="deposit-btn" onclick="modalDeposite('{{parentid}}','{{userid}}','{{availableBalance}}')" style="background-color: green;" >D</span><span class="withdraw-btn" style="background-color: red;"  onclick="modalWithdraw('{{parentid}}','{{userid}}','{{secondrybanlce}}')">W</span>
                              ...
                              {{#if_eq hisabkitabtype 2}}  
								<span class="limit-btn" onclick="modalChangeCredit('{{parentid}}','{{id}}','{{creditRef}}','{{userid}}')">C</span>
 							  {{/if_eq}} 
 ...
 {{#if_eq betlock true}}  
							  ...
							  {{/if_eq}} 
  							  ...
  							  {{#if_eq isaccountclosed flase}}  
								{{else}}
	                             <span class="limit-btn background_red" onclick="accountCloseByParent('{{id}}')">A/C</span>
  							  {{/if_eq}} 
							</td>
							{{/if_eq}}	 
...
<div class="cliennt-container">
    ...
    <!-- main page script -->
<jsp:include page="depositewthdrawmodal.jsp" />   
<%-- <jsp:include page="chanepasswordmodal.jsp" />   --%> 
<jsp:include page="depositemodal.jsp" />  
<jsp:include page="withdrawmodal.jsp" />
<jsp:include page="viewdetaill.jsp" />
<jsp:include page="khatabook.jsp" />
<jsp:include page="changecreditref.jsp" />
