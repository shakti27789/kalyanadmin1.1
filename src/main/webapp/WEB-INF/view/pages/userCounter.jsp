...
<div id="modaluserCounter" class="modal modal-pop bookmodal" tabindex="-1" style="padding-right: 17px;">
	<div class="modal-dialog" style="width: 650px; max-width: 100%;">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">User Counter</h4>
			...
			<div class="modal-body" id="result-details" style="min-height: 300px; padding: 20px 15px!important; display:block;">
				<div class="table-responsive">
					<table class="coupne-table table table-bordered mb-0">
						<thead>
							<tr>
								<th class="" id="t1m">Website</th>
								<th class="" id="t2m">Visted User</th>
								
							</tr>						 
						</thead>
						 <tbody id="user-counter">
