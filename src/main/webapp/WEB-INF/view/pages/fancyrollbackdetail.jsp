...
<div id="modalresult" class="modal modal-pop bookmodal" tabindex="-1" style="padding-right: 17px;">
	<div class="modal-dialog" style="width: 650px; max-width: 100%;">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Fancy RollBack Detail</h4>
