...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="s"%> 
 ...
 <div class="player-number">
            ...
            <div class="player-image-container row">
                ...
                <div class="col-md-12 text-center">
                   <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.[0]}}.png" />
                 
                   <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.[2]}}.png" />
                 
                     <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.[4]}}.png" />
        ...
        <div class="player-number">
            ...
            <div class="player-image-container row">
                <div class="col-md-12 text-center">
                      <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.[1]}}.png" />
                 
              <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.[3]}}.png" />
                 
                    <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.[5]}}.png" />
...
<i class="fas fa-trophy"></i>
 ...
 <div class="player-number">
    ...
    <script id="vLucky7resultHandler" type="text/x-handlebars-template">
 		<div class="player-number">
           <div class="player-image-container row">
                ...
                <div class="col-md-12 text-center">
                   <img  src="<s:url value="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.C1}}.png"/>" />
    ...
    <script id="liveLucky7resultHandler" type="text/x-handlebars-template">
 	<div class="player-number"> {{data}}
           <div class="player-image-container row">
                
                <div class="col-md-12 text-center">
                   <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.card}}.png" />
                 
                </div>
                
                <div class="col-md-12 text-center result_detail" id="detail"><span class="text-success">Result:</span><span>{{data.rdesc}}</span>
                                    </div>
            </div>
        </div>
 ...
 <div class="row player-number col-md-12">
 	...
 	<div class="player-number">
           <div class="player-image-container row">
                ...
                <div class="col-md-12 text-center">
                   <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.cards}}.png" />
...
<script id="livebwtablearesultHandler" type="text/x-handlebars-template">
...
<div class="row player-number col-md-12"><br>
           <div class="col-md-3 text-center">
			...
			<div class="col-md-9 text-right">
  				 <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.[0]}}.png"  width="35"  />
                	 <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.[1]}}.png"  width="35"  />
...
<div class="row player-number col-md-12"><br>
           <div class="col-md-3 text-center">
			...
			<div class="col-md-9 text-right">
  				 <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.[2]}}.png"  width="35"  />
                	 <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.[3]}}.png"  width="35"  />
...
<div class="row player-number col-md-12"><br>
           <div class="col-md-3 text-center">
			...
			<div class="col-md-9 text-right">
  				 <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.[4]}}.png"  width="35"  />
                 <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.[5]}}.png"  width="35"  />
				 <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.[6]}}.png"  width="35"  />
				 <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.[7]}}.png"  width="35"  />
          		 <img  src="https://dzm0kbaskt4pv.cloudfront.net/v2/static/front/img/cards/{{data.[8]}}.png"  width="35"  />
