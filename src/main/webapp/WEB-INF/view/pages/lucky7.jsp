...
<div class="score-panel">
					<div class="lucky7-screen">
						<iframe _ngcontent-hnv-c80="" width="100%" height="420" style="border: 0px;" src="https://shroute.casinovid.in/diamondvideo/sh.php?id=3032"></iframe>
					
<!--<iframe _ngcontent-hnv-c80="" width="100%" height="420" style="border: 0px;" src="https://cricexch.live/video/luckyb"></iframe>-->
				...
				<div class="pl-3 pr-3">
					<div class="row mt-2">
						<div class="col-sm-5 sm-mb-2 text-center">
							<div class="mb-2"><b>{{jdata.[0].runners.[2].back.[0].price}}</b></div>
						...
						<div class="col-sm-2 text-center pt-3">
							<img src="/images/cards/7.jpg" width="40">
						</div>
						<div class="col-sm-5 text-center">
							<div class="mb-2"><b>{{jdata.[0].runners.[0].back.[0].price}}</b></div>
				...
				<div class="row px-2">
					<div class="col-sm-12 text-right mt-2">
						<ul class="cont-lenght mb-0">
							<li><span id="minlowhigh"><b>Min:</b> </span>{{jdata.t2.0.min}}</li>
							<li><span id="maxlowhigh"><b>Max:</b> </span>{{jdata.t2.0.max}}</li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="form-row">
						...
						<div class="paati-seven-cont-part-1">
							<div class="form-row mt-2">
								<div class="col-sm-6 text-center">
									<div class="mb-2"><b>{{jdata.[2].runners.[0].back.[0].price}}</b></div>
									
							<button type="button" id="even" class="patti-count-btn bet-info">EVEN</button>
									<div id="sid3" class="positive">0</div>
								</div>
								<div class="col-sm-6 text-center">
									<div class="mb-2"><b>{{jdata.[2].runners.[1].back.[0].price}}</b></div>
							...
							<div class="form-row px-2 mt-2">
								<div class="col-sm-12 text-right">
									<ul class="cont-lenght mb-0">
										<li id="minevenodd"><span><b>Min:</b> </span>{{jdata.t2.0.min}}</li>
										<li id="maxevenodd"><span><b>Max:</b> </span>{{jdata.t2.0.min}}</li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="col-sm-6">
						<div class="paati-seven-cont-part-2">
							<div class="form-row mt-2">
								<div class="col-sm-6 text-center">
									<div class="mb-2"><b>{{jdata.[1].runners.[0].back.[0].price}}</b></div>
							  <button type="button" id="red" class="patti-count-btn bet-info d-block">
								...
								<div class="col-sm-6 text-center">
									<div class="mb-2"><b>{{jdata.[1].runners.[1].back.[0].price}}</b></div>
							...
							<div class="form-row px-2 mt-2">
								<div class="col-sm-12 text-right">
									<ul class="cont-lenght mb-0">
										...
										<li id="minredblack"><span><b>Min:</b> </span>{{jdata.t2.0.min}}</li>
										<li id="maxredblack"><span><b>Max:</b> </span>{{jdata.t2.0.max}}</li>
									</ul>
								</div>
							</div>
						</div>
...
<script id="vlucky7resulthandler" type="text/x-handlebars-template">
			...
			{{#if_eq result.0.result "1"}}  											
				<span class="ball-runs playera last-result" onclick="resultDetailLiveCasino({{result.0.mid}})" >H</span> 
			{{/if_eq}}
			{{#if_eq result.0.result "2"}}  											
				<span class="ball-runs playerb last-result"  onclick="resultDetailLiveCasino({{result.0.mid}})">L</span> 
			{{/if_eq}}
...
if(${user.usertype} ==4){
	...
	userId ='${user.parentid}';
     ...
     var starCountRefResult = secondaryApp.database().ref(livelucky7data+"/result");
...
var marketId =null;
		function loadHtml(){
			$.ajax({
						type:'GET',
						url:'<s:url value="/api/Lucky7Data/"/>',
						success: function(jsondata, textStatus, xhr) {
							if(xhr.status == 200){ 		
								 ...
								 $("#vlucky7div").html('');
								     ...
								     var starCountRef = secondaryApp.database().ref(livelucky7data+"/data/data");
