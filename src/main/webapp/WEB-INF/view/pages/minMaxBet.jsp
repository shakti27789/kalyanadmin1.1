            ...
            <div class="inner-wrap">
				<div class="row">
					<div class="col-lg-12">
						...
						<li>
						<input type="number" class="form-control" id="minbet" placeholder="Min Bet"/>
						</li>
						<li>
						<input type="number" class="form-control" id="maxbet" placeholder="Max Bet"/>
						</li>
						<li>
						<input type="number" class="form-control" id="betDelay" placeholder="Bet Delay"/>
						</li>
						<li>				 
