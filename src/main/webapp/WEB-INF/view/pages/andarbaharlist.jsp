 		...
 		$.ajax({
			...
			success: function(jsondata, textStatus, xhr) {
				...
				$.each(jsondata, function(key,value){
					 $('#eventlist').append('<div class="col-md-4 m-b-30 div-figure"><a href="<s:url value="/casino/'+value.eventname+'/'+value.eventid+'"/>"><img class="img-fluid" src="<s:url value="/images/banner/'+value.eventid+'.jpeg"/>"></a></div>')
				 });
